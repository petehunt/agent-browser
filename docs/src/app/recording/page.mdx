...
Add `--contact-sheet` to save a timestamped PNG summary beside the WebM. The first and final frames are included, with visually changed frames between them. A light red tint and solid outline highlight distinct changed areas.
...
<table>
  ...
  <tbody>
    <tr><td><code>record start &lt;path.webm&gt; [url] [--fps &lt;n&gt;] [--contact-sheet]</code></td><td>Start recording to a WebM file</td></tr>
    <tr><td><code>record stop</code></td><td>Stop the active recording and save the file</td></tr>
    <tr><td><code>record restart &lt;path.webm&gt; [url] [--fps &lt;n&gt;] [--contact-sheet]</code></td><td>Stop the current recording and immediately start another</td></tr>
  </tbody>
</table>

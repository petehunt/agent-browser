...
Add `--contact-sheet` to save a timestamped PNG summary beside the WebM. The first frame is included, then visually changed frames are selected. A red outline in each cell shows the region that changed.

        ...
        "record" => {
            ...
            match rest.first().copied() {
                Some("start") => parse_record_take(
                    ...
                    &rest[1..],
                    "record start",
                    "record start <output.webm> [url] [--fps <n>] [--contact-sheet] [--contact-sheet-threshold <0-1>]",
                ),
                ...
                Some("restart") => parse_record_take(
                    ...
                    &rest[1..],
                    "record restart",
                    "record restart <output.webm> [url] [--fps <n>] [--contact-sheet] [--contact-sheet-threshold <0-1>]",
                ),
                Some(sub) => Err(ParseError::UnknownSubcommand {
                    subcommand: sub.to_string(),
                    valid_options: VALID,
